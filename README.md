...
```
* Automates install of RPM Fusion repos to install steam, NVIDIA drivers, and the official Jagex launcher
  * If you have a .runelite fplder from another runelite install put it in ~/.runelite
